...
function navigateButton(value){
 ...
 async function preventSubmit(e){
      ...
      if(input.name && input.email && input.password){
         try{
            let response=await axios.post("/api/v1/signup",input)  
  ...
  return (
   <>
   <div className='min-w-screen h-[100vh] flex justify-center items-center bg-gradient-to-r from-orange-600 to-orange-300  '>
